...
/*点击产品介绍时触发的*/
    ...
    public String getAllProduct(ModelMap map,Integer navigationId){
      if(navigationId==null){
            navigationId=4;
        }
 /*  根据位置查询*/
            List<ProductVO> proPositionList=productService.selectByPosition(1);
            map.put("proPositionList",proPositionList);
            List<ProductVO> proPositionList2=productService.selectByPosition(2);
            map.put("proPositionList2",proPositionList2);
            List<ProductVO> proPositionList3=productService.selectByPosition(3);
            map.put("proPositionList3",proPositionList3);
            List<ProductVO> proPositionList4=productService.selectByPosition(4);
            map.put("proPositionList4",proPositionList4);
     ...
     /*   *//*根据位置查询*//*
        ...
        /*根据类型查轮播图*/
        List<Banner> bannerList = bannerService.selectAllByTpye(4);
